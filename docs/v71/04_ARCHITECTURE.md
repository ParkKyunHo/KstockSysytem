...
> **Phase A 완료 (2026-04-28)**: V7.0 Purple-ReAbs는 완전 폐기되었습니다. 본 절은 설계 의도 historical reference로 보존합니다. V7.0 코드 잔재는 git tag `v7.0-final-stable`에서 확인 가능합니다.
...
V7.1 (현재 단독 운영):
  ...
  - 백테스트 없음 (페이퍼 트레이드만)
  - 단일 전략 (박스 눌림/돌파)
  - PATH_A 3분봉 + PATH_B 일봉 (V71CandleManager + V71MarketSchedule)
```
