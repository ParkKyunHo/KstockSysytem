...
| ~~`10_UI_GUIDE.md`~~ | ~~Claude Design 입력용~~ ⚠️ DEPRECATED (shadcn/ui 참고용) | - |
| `10_UI_GUIDE_CARBON.md` | **UI 명세 (Carbon Design System)** ★ | ★★ |
...
프론트엔드:
  - React 18 + TypeScript
  - **IBM Carbon Design System v11+** (@carbon/react)
  - SCSS (@carbon/styles)
  - @carbon/icons-react
  - 차트 렌더링 없음 (HTS 의존)
  
  ⚠️ 2026-04-25 PRD Patch #2: shadcn/ui → Carbon 전환
  자세한 내용: 13_APPENDIX.md §6.2.X
